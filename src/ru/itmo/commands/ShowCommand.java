...
public class ShowCommand extends Command {
    ...
    private static String execute(ConcurrentSkipListMap<Integer, MusicBand> collection) {
        return collection.toString();
    }


    private static String executeWithKey(ConcurrentSkipListMap<Integer, MusicBand> collection, Integer key) {
