...
public class UpdateCommand extends Command {
    ...
    public static String execute(ConcurrentSkipListMap<Integer, MusicBand> collection, Connection connection, User user, Integer key, MusicBand musicBand) {
    ...
    public static String execute(ConcurrentSkipListMap<Integer, MusicBand> collection, Connection connection, User user, String key, MusicBand musicBand) {
